...
//		return target<cap ? target : cap;
	...
	public static boolean isBow(ItemStack itemStack) {
		if itemStack = null && itemStack.getItem().getItemUseAction(itemStack) == EnumAction.BOW;
	}
	...
	public void doProcess(Minecraft minecraft, EntityPlayerSP player){
		...
		if(ammo !=null && notchDist <= notchDistThreshold && controllersDot <= notchDotThreshold)
		{
			...
			if(!isDrawing){
				...
				minecraft.playerController.processRightClick(player, player.world, bow, hand);//server
			}

...
public class GuiKeyBindingSelection extends GuiListExtended
{
    ...
    public class CategoryEntry implements GuiListExtended.IGuiListEntry
    {
		...
		public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
            GuiKeyBindingSelection.this.mc.fontRendererObj.drawString(TextFormatting.AQUA + this.labelText, GuiKeyBindingSelection.this.mc.currentScreen.width / 2 - this.labelWidth / 2, y + slotHeight - GuiKeyBindingSelection.this.mc.fontRendererObj.FONT_HEIGHT - 1, 16777215);
        }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
		...
		public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
            ...
            if(flag)
                GuiKeyBindingSelection.this.mc.fontRendererObj.drawString(TextFormatting.GREEN + this.keyPrettyDesc, x + 190 - GuiKeyBindingSelection.this.maxListLabelWidth, y + slotHeight / 2 - GuiKeyBindingSelection.this.mc.fontRendererObj.FONT_HEIGHT / 2, 16777215);
            else
                GuiKeyBindingSelection.this.mc.fontRendererObj.drawString(TextFormatting.WHITE + this.keyPrettyDesc, x + 190 - GuiKeyBindingSelection.this.maxListLabelWidth, y + slotHeight / 2 - GuiKeyBindingSelection.this.mc.fontRendererObj.FONT_HEIGHT / 2, 16777215);

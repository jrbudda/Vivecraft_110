...
public class QuaternionHelper
{
    ...
    public static Quaternion exp(Quaternion input)
    {
        ...
        Math.exp(inputA) * (inputV.normalize().xCoord * (float)Math.sin(inputV.lengthVector())),
        Math.exp(inputA) * (inputV.normalize().yCoord * (float)Math.sin(inputV.lengthVector())),
        Math.exp(inputA) * (inputV.normalize().zCoord * (float)Math.sin(inputV.lengthVector())));

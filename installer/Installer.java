...
public class Installer extends JPanel  implements PropertyChangeListener
{
    ...
    private static String FORGE_VERSION     = "12.18.3.2511";
	...
	private static final String GITHUB_LINK = "https://github.com/jrbudda/Vivecraft_110";
	...
	public Installer(File target)
	{
		...
		JLabel tag = new JLabel("Welcome! This will install Vivecraft NONVR "+ version);
